...
import { generatGoogleMapUrl, secureImageUrl } from '../../app/utils/configs.ts'

describe('secureImageUrl', () => {
  it('rewrites http to https', () => {
    expect(secureImageUrl('http://cdn.example.com/x.jpg')).toBe('https://cdn.example.com/x.jpg')
  })

  it('leaves https untouched', () => {
    expect(secureImageUrl('https://cdn.example.com/x.jpg')).toBe('https://cdn.example.com/x.jpg')
  })
